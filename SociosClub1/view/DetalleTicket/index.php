...
?>
  ...
  <title>SociosClub</>::Detalle Ticket</title>
  </head>
          ...
          <div class="row">
              ...
              <div class="col-lg-6">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="nombreDeporte">Deporte</label>
                  <input type="text" class="form-control" id="nombreDeporte" name="nombreDeporte" readonly>
                </fieldset>
              </div>
